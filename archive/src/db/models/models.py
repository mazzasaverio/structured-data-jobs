...
class CompanyUrl(Base):
    ...
    frontier_urls: Mapped[List["FrontierUrl"]] = relationship(
...
class FrontierUrl(Base):
    ...
    company_id: Mapped[int] = mapped_column(
        ForeignKey("company_urls.id"), nullable=False
    )
...
class JobPost(Base):
    ...
    job_detail: Mapped["JobDetail"] = relationship(
...
class JobDetail(Base):
    ...
    job_post_id: Mapped[int] = mapped_column(
        ForeignKey("job_posts.id"), unique=True, nullable=False
    )
